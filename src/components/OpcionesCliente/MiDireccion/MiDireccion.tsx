...
const Direccion: FC = () => {
      ...
      try {
        ...
        const usuarioEncontrado = usuarioDB.find(
          (usuario: IUsuario) =>
            ...
            usuario.email === usuarioContext?.email
        );
        if (usuarioEncontrado) {
          setUsuario(usuarioEncontrado);
          // Obtener el domicilio del usuario
          const domicilioResponse = await axios.get(
            `${API_URL}usuario/${usuarioEncontrado.id}/domicilio`
          );
  ...
  return (
    <div
      ...
      style={{
        backgroundImage: `url('/assets/img/Fondo-UbicacionPerfil.jpg') `,
        minHeight: "100vh",
      }}
    >
      <Container>
        ...
        {domicilio ? (
          ...
          <>
            ...
            {isLoading && ( // Mostrar el spinner mientras se están cargando las solicitudes
