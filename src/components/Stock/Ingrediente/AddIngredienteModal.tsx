  ...
  useEffect(() => {
    const fetchRubros = async () => {
      try {
        ...
        const filteredRubros = responseData.data.filter(
              ...
              <Form.Group className="mb-3" controlId="formMinStock">
                ...
                <Form.Control
                  ...
                  onChange={(event) =>
                    setNewIngrediente({
                      ...newIngrediente,
                      stockMinimo: parseInt(event.target.value),
                    })
                  }
                  required
                />
              ...
              <Form.Group className="mb-3" controlId="formStockActual">
                ...
                <Form.Control
                  ...
                  onChange={(event) =>
                    setNewIngrediente({
                      ...newIngrediente,
                      stockActual: parseInt(event.target.value),
                    })
                  }
                  required
                />
              ...
              <Form.Group className="mb-3" controlId="formPrecioCosto">
                ...
                <Form.Control
                  ...
                  onChange={(event) =>
                    setNewIngrediente({
                      ...newIngrediente,
                      precioCosto: parseInt(event.target.value),
                    })
                  }
                  required
                  min={1}
              ...
              <Form.Group className="mb-3" controlId="formEstado">
                ...
                <Form.Select
                  ...
                  onChange={(event) =>
                    setNewIngrediente({
                      ...newIngrediente,
                      activo: event.target.value === "alta",
                    })
                  }
                  required
                >
