...
const Navbar: FC = () => {
  ...
  <div className="logo" style={{ display: 'flex', alignItems: 'center' }}>
    <img className="logo-iluminatti-1" src={logo} alt="logo" style={{ width: '50px', height: '50px', borderRadius: '50%', marginRight: '10px' }} />
  ...
  <div className="frame-11" style={{ display: 'flex', alignItems: 'center', justifyContent: 'flex-end' }}>
    <div className="lupa">
      <img className="icon-lupa-2-1" src={lupa} alt="icono de lupa" style={{ width: '50px', height: '50px', borderRadius: '50%', marginRight: '10px' }} />
    </div>

    <div className="carrito-de-compra">
      <img className="descarga-1" src={carrito} alt="icono de carrito de compra" style={{ width: '50px', height: '50px', borderRadius: '50%', marginRight: '10px' }} />
    </div>
